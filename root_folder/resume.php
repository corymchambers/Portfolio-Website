...
<html lang="en">
     ...
     <body>
         ...
         <div class="jumbotron">
			 <h1>Resume</h1><br>
             <img src="images/resume.jpg" class="center-image" alt="Resume" />
             <a href="docs/resume.docx" target="_blank" ><h5 style="text-align:center; color:#43412E;">Download Resume</h5></a>
		 </div><!--end Main Area-->
