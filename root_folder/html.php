...
<html lang="en">
     ...
     <body>
         ...
         <div class="jumbotron">
			 <h1>HTML5/CSS3</h1><br>
			 <p>The portfolio Web site that you are viewing was built with <strong class="key">HTML5</strong> and <strong class="key">CSS3</strong> in mind. The tags used to structure the document are newer HTML5 tags such as &lt;article&gt; &lt;nav&gt; &lt;header&gt; and &lt;footer&gt;.</p>
			 <p>Vendor prefixes have been used to ensure <strong class="key">cross-browser capability</strong> so for example those using the Firefox browser will be able to see rounded corners even though it is not a standard yet.</p>
			 <p>Alt tags have used to comply with W3C Accessiblity Guidelines. Media-queries have been used to change the presentation with the size of the screen to <strong class="key">support multiple devices</strong></p>
			 <h1>Drag & Drop Shopping Cart</h1><br>
